...
public class QuestionBank {
    private static final List<Question> masterQuestionList = List.of(
            ...
            new Question("Math", "What class is Math 236?", List.of("Linear Algebra", "Calculus 3", "Network Science", "Calc 2")),
            new Question("Chem", "What is the most oxidizing element?", List.of("F", "Cl", "O", "N")),
            new Question("Chem", "Which is the most abundant element in your body?", List.of("C", "Fe", "O", "N")),
            new Question("Chem", "Who discovered oxygen in the air?", List.of("de Lavoisier", "Le Chatelier", "Robert Boyle", "Amedeo Avogadro")),
            new Question("Chem", "How does CO kill people?", List.of("coordination bonding", "covalent bonding", "LDF", "Hydrogen bonding")),
            ...
            new Question("Math", "What has to be true for f to be Riemann integrable?", List.of("U(f) = L(f)", "L(P) = A(P)", "K(a) = K(b)", "A=B=C=D")),
            new Question("Math", "What's the # of Federal Rules of Evidence for relevance? ", List.of("399+2", "444-40", "10+43", "99*4")),
            ...
            new Question("Chem", "Who discovered the element H?", List.of("Henry Cavendish", "Priestley", "Robert Boyle", "de Lavoisier")),
            ...
            new Question("Math", "How many sessions of STAT 155 does MSCS offer in Spring 2020?", List.of("4", "2", "3", "6")),
